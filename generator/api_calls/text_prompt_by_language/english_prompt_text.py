...
DEFAULT_DICTIONARY_URLS = ["oxfordlearnersdictionaries.com", "ldoceonline.com"]
...
prompt_preamble = f"""I want you to act like a professional Anki card maker,
able to create Anki cards from the text I provide.

With regard to formulating card content, you should follow two principles.
1. Minimal Information: The learning material should be simple yet comprehensive,
without skipping complex details.
2. Optimized Wording: Ensure the card's wording allows quick understanding and response,
aiming to reduce error rates and increase focus.
3. You should use {get_target_dictionary_urls()} as primary source for definitions
and examples
...
- Provide cards with or without context:
  ...
  - With Context: Use the provided context.
  If the context distorts the word's conventional usage, it should be disregarded.
- Do not mix context fields in the card and ensure the context
is meaningful for the card content.
...
- You should add 3-4 short examples of the word usage.
- Between definition and examples should be empty \n symbol

Masking Rules:
- Mask the target word with underscores,
preserving spaces between words ("free will" becomes "____ ____").
- Number of underscores should match the number of the letters ("salvation" becomes "_________")
- Only mask the target word, not its contextual usage.
For instance, "seizure" in "ship seizure" should only mask "seizure."
...
def examples() -> str:
    ...
    _examples = {
        "struggle": [
            "",
            "Something that can only be accomplished with great effort is said to be a ________. "
        ...
        "jot down": [
            ...
            "It's a good word to use when you're writing a brief note, a phone number, "
            "or a list — especially when you're doing it in a hurry. ",
        ],
        "attitude": [
            "",
            "An ________ is somewhere between a belief, a stance, a mood, and a pose. "
        ...
        "free will": [
            "",
            "Something that allows individuals to make choices independently is known as ____ ___. "
        ...
        "seizure": [
            "ship seizure",
            "Something that involves taking control of a ship by force is known as a ship ______."
    ...
    anki_examples_strings = [
        f"WORD: [{word}]; CONTEXT: [{_examples[word][0]}]; RESULT:[{_examples[word][1]}]\n"
